from .kitchen_envs import KitchenMicrowaveKettleLightSliderV0, KitchenMicrowaveKettleBottomBurnerLightV0, \
    KitchenMicrowaveLightSliderHingeV0, KitchenKettleBottomBurnerTopBurnerSliderV0, KitchenMicrowaveBottomLightSliderV0, \
    KitchenAllTasksV0
...
register(
    id='kitchen-mbls-v0',
    entry_point='d4rl.kitchen:KitchenMicrowaveBottomLightSliderV0',
    max_episode_steps=280,
    kwargs={
        'ref_min_score': 0.0,
        'ref_max_score': 4.0,
