...
class VQCDTPredictor(nn.Module):
    ...
    def intermediate_features_construct(self):
        ...
        """
        features = self.fl_leaf_weights.view(-1, self.input_dim) @ self.data.transpose(0,1)   # data: (batch_size, feature_dim); return: (num_fl_leaves*num_intermediate_variables, batch)
