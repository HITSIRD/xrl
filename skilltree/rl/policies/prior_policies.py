...
from skilltree.modules.variational_inference import MultivariateGaussian, mc_kl_divergence
from skilltree.rl.components.agent import BaseAgent
from skilltree.rl.components.policy import Policy
from skilltree.rl.policies.mlp_policies import SplitObsMLPPolicy, MLPPolicy, HybridConvMLPPolicy
from skilltree.utils.general_utils import AttrDict, ParamDict
from skilltree.utils.pytorch_utils import no_batchnorm_update
...
class LearnedVQPriorAugmentedPIPolicy(PriorInitializedPolicy, LearnedPriorAugmentedPolicy):
    def __init__(self, config):
        LearnedPriorAugmentedPolicy.__init__(self, config)
