...
from skilltree.modules.subnetworks import Predictor, HybridConvMLPEncoder, Encoder
...
from skilltree.utils.general_utils import ParamDict, AttrDict
from skilltree.utils.pytorch_utils import RemoveSpatial
...
class ConvPolicy(MLPPolicy):
    """Encodes input image with conv encoder, then uses MLP head to produce output action distribution."""
    def _default_hparams(self):
        default_dict = ParamDict({
