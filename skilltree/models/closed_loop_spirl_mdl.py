...
from skilltree.modules.subnetworks import Predictor, BaseProcessingLSTM, Encoder
...
class ClSPiRLMdl(SkillPriorMdl):
    ...
    def _run_inference(self, inputs):
        ...
        enc = self._get_seq_enc(inputs)
        inf_input = torch.cat((inputs.actions, enc), dim=-1)
