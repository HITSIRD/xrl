...
from skilltree.modules.subnetworks import Predictor, VQPredictor, BaseProcessingLSTM, Encoder
from skilltree.modules.variational_inference import MultivariateGaussian, Gaussian
...
class ImageClVQSPiRLMdl(ClVQSPiRLMdl, ImageSkillPriorMdl):
