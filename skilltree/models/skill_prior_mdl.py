...
from skilltree.components.base_model import BaseModel
from skilltree.components.logger import Logger
from skilltree.components.checkpointer import load_by_key, freeze_modules
from skilltree.modules.losses import KLDivLoss, NLL
from skilltree.modules.subnetworks import BaseProcessingLSTM, Predictor, Encoder
from skilltree.modules.recurrent_modules import RecurrentPredictor
from skilltree.utils.general_utils import AttrDict, ParamDict, split_along_axis, get_clipped_optimizer
from skilltree.utils.pytorch_utils import map2np, ten2ar, RemoveSpatial, ResizeSpatial, map2torch, find_tensor, \
    TensorModule, RAdam
from skilltree.utils.vis_utils import fig2img
from skilltree.modules.variational_inference import ProbabilisticModel, Gaussian, MultivariateGaussian, get_fixed_prior, \
    mc_kl_divergence
from skilltree.modules.layers import LayerBuilderParams
...
class SkillPriorMdl(BaseModel, ProbabilisticModel):
    ...
    def _log_outputs(self, model_output, inputs, losses, step, log_images, phase, logger, **logging_kwargs):
        ...
        self._logger.log_scalar(model_output.prior_entropy, "prior entropy", step, phase)
