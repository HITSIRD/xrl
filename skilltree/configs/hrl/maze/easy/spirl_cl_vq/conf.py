...
ll_policy_params = AttrDict(
    ...
    policy_model_checkpoint=os.path.join(os.environ["EXP_DIR"], "skill_prior_learning/maze/easy/hierarchical_cl_vq"),
...
hl_agent_config.update(AttrDict(
    ...
    td_schedule_params=AttrDict(p=2.0),
))
