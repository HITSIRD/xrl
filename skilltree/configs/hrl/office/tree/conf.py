...
from strl.rl.policies.prior_policies import LearnedPriorAugmentedPIPolicy, LearnedVQPriorAugmentedPolicy
...
ll_policy_params = AttrDict(
    ...
    policy_model_checkpoint=os.path.join(os.environ["EXP_DIR"],
                                         "skill_prior_learning/office/hierarchical_cl_vq"),
...
hl_policy_params.update(AttrDict(
    policy=CARTPolicy,
    policy_model_checkpoint=os.path.join(os.environ["EXP_DIR"],
                                         "/home/wenyongyan/文档/CART/office/cart_1000_d8.pkl"),
    codebook_checkpoint=os.path.join(os.environ["EXP_DIR"],
                                     "hrl/office/spirl_cl_vq/k16_s1/weights/weights_ep14.pth"),
    # max_depth=10,
