...
from skilltree.rl.policies.cl_model_policies import ACClModelPolicy
from skilltree.rl.policies.prior_policies import ACLearnedVQPriorAugmentedPIPolicy
from skilltree.rl.agents.prior_discrete_sac_agent import ActionPriorDiscreteSACAgent
...
hl_agent_config.policy = ACLearnedVQPriorAugmentedPIPolicy

# update HL policy model params
hl_policy_params.update(AttrDict(
    policy=ACLearnedVQPriorAugmentedPIPolicy,  # PriorInitializedPolicy PriorAugmentedPolicy
