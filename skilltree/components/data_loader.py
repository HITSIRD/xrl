...
from skilltree.utils.general_utils import (AttrDict, map_dict, maybe_retrieve, shuffle_with_seed)
from skilltree.utils.pytorch_utils import (RepeatedDataLoader)
from skilltree.utils.video_utils import (resize_video)
    ...
    def _get_raw_data(self, index):
        ...
        try:
            with h5py.File(path, 'r') as F:
                ...
                if key + '/observations' in F:
                    data.images = F[key + '/observations'][()]
                else:
