...
import inspect
from skilltree.modules.layers import BaseProcessingNet, FCBlock
from skilltree.modules.losses import L2Loss
from skilltree.modules.variational_inference import stack
from skilltree.utils.general_utils import AttrDict, batchwise_assign, map_dict, \
    concat_inputs, listdict2dictlist, subdict
from skilltree.utils.general_utils import broadcast_final
...
class MLPLSTMCellInitializer(LSTMCellInitializer):
    ...
    def __init__(self, hp, cell, input_sz):
        ...
        from skilltree.modules.subnetworks import Predictor    # to avoid cyclic import
