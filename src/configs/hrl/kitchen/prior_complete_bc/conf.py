...
from src.rl.policies.oracle_policy import OraclePolicy
from src.rl.components.agent import SubtaskIntervalHierarchicalAgent

epoch = 9

configuration.update(AttrDict(
    # agent=SubtaskIntervalHierarchicalAgent,
...
ll_policy_params = AttrDict(
    ...
    policy_model=OneHotImagePriorCompleteBCModel,
    policy_model_params=ll_model_params,
    policy_model_checkpoint=os.path.join(os.environ["EXP_DIR"], "skill/kitchen/prior_complete_bc"),
)
