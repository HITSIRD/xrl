from src.configs.hrl.real_kitchen.cola.base_conf import *
from src.configs.skill.real_kitchen.cola.transformer_prior_bc.conf import model_config
...
ll_policy_params = AttrDict(
    ...
    policy_model_checkpoint=os.path.join(os.environ["EXP_DIR"],
                                         "skill/real_kitchen/cola/transformer_prior_bc"),
)
