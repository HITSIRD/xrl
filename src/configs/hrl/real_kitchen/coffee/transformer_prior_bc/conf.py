from src.configs.hrl.real_kitchen.coffee.base_conf import *
from src.configs.skill.real_kitchen.coffee.transformer_prior_bc.conf import model_config
from src.models.bc import TransformerOneHotImagePriorBCModel
...
ll_policy_params = AttrDict(
    ...
    policy_model=TransformerOneHotImagePriorBCModel,
    policy_model_params=ll_model_params,
    policy_model_checkpoint=os.path.join(os.environ["EXP_DIR"],
                                         "skill/real_kitchen/coffee/transformer_prior_bc"),
)
