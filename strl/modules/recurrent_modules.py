...
import inspect
from strl.modules.layers import BaseProcessingNet, FCBlock
from strl.modules.losses import L2Loss
from strl.modules.variational_inference import stack
from strl.utils.general_utils import AttrDict, batchwise_assign, map_dict, \
    concat_inputs, listdict2dictlist, subdict
from strl.utils.general_utils import broadcast_final
...
class MLPLSTMCellInitializer(LSTMCellInitializer):
    ...
    def __init__(self, hp, cell, input_sz):
        ...
        from strl.modules.subnetworks import Predictor    # to avoid cyclic import
