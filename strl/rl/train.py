...
class RLTrainer:
    ...
    def _default_hparams(self):
        default_dict = ParamDict({
            ...
            'log_output_per_epoch': 200,  # log the non-image/video outputs N times per epoch
