...
from strl.modules.variational_inference import MultivariateGaussian, mc_kl_divergence
from strl.rl.components.agent import BaseAgent
from strl.rl.components.policy import Policy
from strl.rl.policies.mlp_policies import SplitObsMLPPolicy, MLPPolicy, HybridConvMLPPolicy
...
class LearnedPriorAugmentedPIPolicy(LearnedPriorAugmentedPolicy, PriorInitializedPolicy):
    def __init__(self, config):
...
class LearnedVQPriorAugmentedPolicy(PriorInitializedPolicy, LearnedPriorAugmentedPolicy):
    def __init__(self, config):
        LearnedPriorAugmentedPolicy.__init__(self, config)
...
class ACLearnedPriorAugmentedMLPPolicy(ACLearnedPriorAugmentedPolicy, SplitObsMLPPolicy):
    ...
    def __init__(self, config):
        ...
        ACLearnedPriorAugmentedPolicy.__init__(self, self._hp.overwrite(
            config))  # this is fsr necessary for it not to throw an error
