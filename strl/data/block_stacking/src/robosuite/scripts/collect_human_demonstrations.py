...
from strl.data.block_stacking.src import robosuite
import strl.data.block_stacking.src.robosuite.utils.transform_utils as T
from strl.data.block_stacking.src.robosuite.wrappers import IKWrapper
from strl.data.block_stacking.src.robosuite.wrappers import DataCollectionWrapper
...
if __name__ == "__main__":
    ...
    if args.device == "keyboard":
        from strl.data.block_stacking.src.robosuite import Keyboard
        ...
        from strl.data.block_stacking.src.robosuite import SpaceMouse
