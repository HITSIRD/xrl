...
from strl.data.block_stacking.src.robosuite.models.arenas import BinsArena
from strl.data.block_stacking.src.robosuite.models.objects import (
    MilkObject,
    BreadObject,
    CerealObject,
    CanObject,
...
from strl.data.block_stacking.src.robosuite.models.tasks import PickPlaceTask
