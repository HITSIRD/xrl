...
from strl.data.block_stacking.src.robosuite.environments import MujocoEnv

from strl.data.block_stacking.src.robosuite.models.grippers import gripper_factory
from strl.data.block_stacking.src.robosuite.models.robots.baxter_robot import Baxter
...
class BaxterEnv(MujocoEnv):
    ...
    def _joint_positions_getter(self):
