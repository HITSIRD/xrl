...
from strl.rl.agents.skill_space_agent import SkillSpaceAgent, ACSkillSpaceAgent
...
class MazeACActionPriorSACAgent(ActionPriorSACAgent, MazeAgent):
    def __init__(self, *args, **kwargs):
        ...
        from strl.rl.components.replay_buffer import SplitObsUniformReplayBuffer
