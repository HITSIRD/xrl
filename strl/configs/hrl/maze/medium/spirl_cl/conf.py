...
from strl.rl.envs.maze import ACRandMaze0S30Env
...
ll_policy_params = AttrDict(
    ...
    policy_model_checkpoint=os.path.join(os.environ["EXP_DIR"], "skill_prior_learning/maze/medium/hierarchical_cl"),
