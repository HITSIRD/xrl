...
from strl.models.closed_loop_vq_cdt_mdl import ClVQCDTMdl, ClVQCDTMdlExtension
...
prior_model_name = "cdt_k16_s2_-1+60+6+1_1"
...
ll_policy_params = AttrDict(
    ...
    policy_model_checkpoint=os.path.join(os.environ["EXP_DIR"],
                                         f"skill_prior_learning/kitchen/hierarchical_cl_vq_cdt_extension/{prior_model_name}"),
)
